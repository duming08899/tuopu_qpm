...
public class BaseController {
    ...
    public void setAttributeSeq(SeqTypeAttr seqTypeAttr, HttpServletRequest request) {
        String seq = String.format("%05d", SeqUtil.getSeq(seqTypeAttr.getValue()));
        String code = seqTypeAttr.getValue() + DateUtils.getCurrentTime("YYMMDD") + seq;
