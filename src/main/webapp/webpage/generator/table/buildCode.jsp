  ...
  <div class="portlet-body form">
  	<form id="buildCodeForm" class="form-horizontal form-bordered" action="/generator/buildCode" method="post">
        ...
        <div class="col-md-4">
        	<div class="input-icon right" onclick="openFolder()">
	          ...
	          <input type="text" class="form-control" id="projectPath" name="projectPath"  value="/Volumes/Mandy/gennator/gen" required/>
	        </div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        	<div class="input-icon right">
	        	<i class="fa"></i>
	          <input type="text" class="form-control" name="entityPackage" value="${tableConfig.packageName}" placeholder="test" required maxlength="200"/>
	        </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
        	<div class="input-icon right">
	        	<i class="fa"></i>
        		<input type="text" class="form-control" name="webBasePackage" value="webpage/${tableConfig.packageName}" placeholder="webpage/test" required/>
        	</div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        	<div class="input-icon right">
	        	<i class="fa"></i>
	          <input type="text" class="form-control" name="author" value="duming" required/>
	        </div>
        </div>
      </div>
