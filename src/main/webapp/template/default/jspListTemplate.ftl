	...
	<table class="table table-striped table-hover table-success">
		...
		<tbody>
			...
			<tr>
				...
				<td>${'$'}{${className?uncap_first}.updateUser}</td>
				<td><fmt:formatDate value="${'$'}{${className?uncap_first}.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>
					<sys:constantTag type="status" value="${'$'}{${className?uncap_first}.status}" function="V" />
				</td>
				<td>
